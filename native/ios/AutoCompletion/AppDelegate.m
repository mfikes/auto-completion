...
{
  [context evaluateScript:[NSString stringWithFormat:@"goog.require('%@');", [self munge:@"auto-completion.core"]]];
}
...
- (void)contentDidAppear
{
  ...
  JSValue* initFn = [self getValue:@"init" inNamespace:@"auto-completion.core" fromContext:context];
